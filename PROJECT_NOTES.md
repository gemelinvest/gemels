...
- ניסוחי ה-CTA
- פריטי הניווט
- קבוצות התפריט (`menuGroups`): ביטוחי פרט, חיים בריאות ופנסיה, ביטוח עסקים. כל פריט מקשר לעוגן בדף הבית
...
- מייל קבוע במקום `info@gemels.co.il`
- מספר רישיון, אם יש למסור אותו
- שעות פעילות
- חיבור הטופס לשרת
- בדיקת נגישות חיצונית
- דומיין סופי במקום כתובת GitHub Pages
...
4. לא להוסיף ל-schema רישיון או שנות פעילות שלא נמסרו. הכתובת והח.פ. כבר מולאו.
